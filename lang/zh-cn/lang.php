    ...
    return [
        ...
        'components' => [
            ...
            'shared' => [
                ...
                'mail_template'     => ['title' => '邮件模板'      , 'description' => 'Use custom mail template. Specify template code like "blakejones.magicforms::mail.notification" (found on Settings, Mail templates). Leave empty to use default.'],

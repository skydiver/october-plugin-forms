...
abstract class MagicForm extends ComponentBase {
    ...
    private function _prepareJavaScript() {
        ...
        /* RECAPTCHA JS */
        if ($this->isReCaptchaEnabled()) {
            $code .= $content = $this->renderPartial('@include-js', ['file' => 'plugins/martin/forms/components/partials/js/recaptcha.js']);
        }

        /* RESET FORM JS */
        if ($this->property('reset_form')) {
            $code .= $content = $this->renderPartial('@include-js', ['file' => 'plugins/martin/forms/components/partials/js/reset-form.js', 'id' => '#' . $this->alias . '_forms_flash']);
            if ($this->property('uploader_enable')) {
                $code .= $content = $this->renderPartial('@include-js', ['file' => 'plugins/martin/forms/components/partials/js/reset-uploader.js', 'id' => $this->alias]);
            }
        }
